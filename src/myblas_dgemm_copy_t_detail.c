	    ...
	    while( m4-- ){
	      ...
	      if( K >> 3 ){
	       ...
	       __asm__ __volatile__ (
	         ...
	         "vmovapd   0*8(%[a3]        ), %%ymm3 \n\t" // [x03,x13,x23,x33]
	         "\n\t"
	         "vmovapd   0*8(%[a0],%[lda1],4), %%ymm4 \n\t" // [x00,x10,x20,x30]
	         "vmovapd   0*8(%[a1],%[lda1],4), %%ymm5 \n\t" // [x01,x11,x21,x31]
	         "vmovapd   0*8(%[a2],%[lda1],4), %%ymm6 \n\t" // [x02,x12,x22,x32]
	         "vmovapd   0*8(%[a3],%[lda1],4), %%ymm7 \n\t" // [x03,x13,x23,x33]
	         "\n\t"
	       :[a0]"+r"(a0),[a1]"+r"(a1),[a2]"+r"(a2),[a3]"+r"(a3),[aa]"+r"(A2)
	       :[lda1]"r"(lda1),[lda2]"r"(lda2) );
	        ...
	        while( k8-- ){
	          ...
	          __asm__ __volatile__ (
	            ...
	            "vmovapd   %%ymm0 ,   0*8(%[aa])\n\t"
	            "vmovapd   %%ymm1 ,   4*8(%[aa])\n\t"
	            "vmovapd   0*8(%[a0],%[lda1],8), %%ymm0 \n\t" // [x00,x10,x20,x30]
	            "vmovapd   0*8(%[a1],%[lda1],8), %%ymm1 \n\t" // [x01,x11,x21,x31]
	            "vmovapd   %%ymm2 ,   8*8(%[aa])\n\t"
	            "vmovapd   %%ymm3 ,  12*8(%[aa])\n\t"
	            "vmovapd   0*8(%[a2],%[lda1],8), %%ymm2 \n\t" // [x02,x12,x22,x32]
	            "vmovapd   0*8(%[a3],%[lda1],8), %%ymm3 \n\t" // [x03,x13,x23,x33]
	            "\n\t"
	            "leaq    0(%[a0],%[lda1],8), %[a0]\n\t"
	            "leaq    0(%[a1],%[lda1],8), %[a1]\n\t"
	            "leaq    0(%[a2],%[lda1],8), %[a2]\n\t"
	  ...
	  if( M & 2 ){
	      ...
	      if( K >> 3 ){
	        ...
	        __asm__ __volatile__ (
	          ...
	          "movapd   0*8(%[a3]        ), %%xmm3 \n\t" // [x03,x13]
	          "\n\t"
	          "movapd   0*8(%[a0],%[lda1],4), %%xmm4 \n\t" // [x00,x10]
	          "movapd   0*8(%[a1],%[lda1],4), %%xmm5 \n\t" // [x01,x11]
	          "movapd   0*8(%[a2],%[lda1],4), %%xmm6 \n\t" // [x02,x12]
	          "movapd   0*8(%[a3],%[lda1],4), %%xmm7 \n\t" // [x03,x13]
	          "\n\t"
	        :[a0]"+r"(a0),[a1]"+r"(a1),[a2]"+r"(a2),[a3]"+r"(a3),[aa]"+r"(A2)
	        :[lda1]"r"(lda1) );
	        ...
	        while( k8-- ){
	          ...
	          __asm__ __volatile__ (
	            ...
	            "movapd   %%xmm0 ,   0*8(%[aa])\n\t"
	            "movapd   %%xmm1 ,   2*8(%[aa])\n\t"
	            "movapd   0*8(%[a0],%[lda1],8), %%xmm0 \n\t" // [x00,x10]
	            "movapd   0*8(%[a1],%[lda1],8), %%xmm1 \n\t" // [x01,x11]
	            "\n\t"
	            "movapd   %%xmm2 ,   4*8(%[aa])\n\t"
	            "movapd   %%xmm3 ,   6*8(%[aa])\n\t"
	            "movapd   0*8(%[a2],%[lda1],8), %%xmm2 \n\t" // [x02,x12]
	            "movapd   0*8(%[a3],%[lda1],8), %%xmm3 \n\t" // [x03,x13]
	            "\n\t"
	            "leaq    0(%[a0],%[lda1],8), %[a0]\n\t"
	            "leaq    0(%[a1],%[lda1],8), %[a1]\n\t"
	            "leaq    0(%[a2],%[lda1],8), %[a2]\n\t"
	       ...
	       :[lda1]"r"(lda1),[lda2]"r"(lda2) );
	        ...
	        while( k8-- ){
	          ...
	          __asm__ __volatile__ (
	            ...
	            "vmovapd   %%ymm0 ,   0*8(%[aa])\n\t"
	            "vmovapd   %%ymm1 ,   4*8(%[aa])\n\t"
	            "vmovupd   0*8(%[a0],%[lda1],8), %%ymm0 \n\t" // [x00,x10,x20,x30]
	            "vmovupd   0*8(%[a1],%[lda1],8), %%ymm1 \n\t" // [x01,x11,x21,x31]
	            "vmovapd   %%ymm2 ,   8*8(%[aa])\n\t"
	            "vmovapd   %%ymm3 ,  12*8(%[aa])\n\t"
	            "vmovupd   0*8(%[a2],%[lda1],8), %%ymm2 \n\t" // [x02,x12,x22,x32]
	            "vmovupd   0*8(%[a3],%[lda1],8), %%ymm3 \n\t" // [x03,x13,x23,x33]
	            "\n\t"
	            "leaq    0(%[a0],%[lda1],8), %[a0]\n\t"
	            "leaq    0(%[a1],%[lda1],8), %[a1]\n\t"
	            "leaq    0(%[a2],%[lda1],8), %[a2]\n\t"
	      ...
	      if( K >> 3 ){
	        ...
	        while( k8-- ){
	          ...
	          __asm__ __volatile__ (
	            ...
	            "movapd   %%xmm0 ,   0*8(%[aa])\n\t"
	            "movapd   %%xmm1 ,   2*8(%[aa])\n\t"
	            "movupd   0*8(%[a0],%[lda1],8), %%xmm0 \n\t" // [x00,x10]
	            "movupd   0*8(%[a1],%[lda1],8), %%xmm1 \n\t" // [x01,x11]
	            "\n\t"
	            "movapd   %%xmm2 ,   4*8(%[aa])\n\t"
	            "movapd   %%xmm3 ,   6*8(%[aa])\n\t"
	            "movupd   0*8(%[a2],%[lda1],8), %%xmm2 \n\t" // [x02,x12]
	            "movupd   0*8(%[a3],%[lda1],8), %%xmm3 \n\t" // [x03,x13]
	            "\n\t"
	            "leaq    0(%[a0],%[lda1],8), %[a0]\n\t"
	            "leaq    0(%[a1],%[lda1],8), %[a1]\n\t"
	            "leaq    0(%[a2],%[lda1],8), %[a2]\n\t"
