	      ...
	      if( M >> 2 ){
	        ...
	        while( m4-- ){
	          ...
	          __asm__ __volatile__ (
	            ...
	            "vmovapd  4*8(%[a0],%[lda2]  ), %%ymm2 \n\t"
	            "vmovapd  4*8(%[a1],%[lda2]  ), %%ymm3 \n\t"
	            ...
	            "vmovapd  4*8(%[a0],%[lda2],2), %%ymm4 \n\t"
	            "vmovapd  4*8(%[a1],%[lda2],2), %%ymm5 \n\t"
	            "vmovapd  %%ymm6 , 24*8(%[a2]) \n\t"
	            "vmovapd  %%ymm7 , 28*8(%[a2]) \n\t"
	            "vmovapd  4*8(%[a0],%[lda3],2), %%ymm6 \n\t"
	            "vmovapd  4*8(%[a1],%[lda3],2), %%ymm7 \n\t"
	            "\n\t"
	            "addq  $4*8, %[a0]\n\t"
	            "addq  $4*8, %[a1]\n\t"
	            "leaq  0*8(%[a2],%[K],4), %[a2]\n\t"
