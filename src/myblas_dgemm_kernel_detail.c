	        ...
	        if( K >> 3 ){
	          ...
	          while( k8-- ){
	            ...
	            __asm__ __volatile__ (
	                ...
	                "vmovapd  12*8(%[b]), %%ymm7 \n\t"
	                "\n\t"
	                "vperm2f128 $0x00, %%ymm0, %%ymm0, %%ymm8 \n\t"
	                "vperm2f128 $0x11, %%ymm0, %%ymm0, %%ymm9 \n\t"
	                "vshufpd    $0x00, %%ymm4, %%ymm4, %%ymm10\n\t"
	                "vshufpd    $0x0f, %%ymm4, %%ymm4, %%ymm11\n\t"
	                "vfmadd231pd %%ymm8 , %%ymm10, %%ymm12\n\t"
	                "vfmadd231pd %%ymm9 , %%ymm10, %%ymm13\n\t"
	                "vfmadd231pd %%ymm8 , %%ymm11, %%ymm14\n\t"
	                "vfmadd231pd %%ymm9 , %%ymm11, %%ymm15\n\t"
	                "vperm2f128 $0x00, %%ymm1, %%ymm1, %%ymm8 \n\t"
	                "vperm2f128 $0x11, %%ymm1, %%ymm1, %%ymm9 \n\t"
	                ...
	                "vfmadd231pd %%ymm9 , %%ymm11, %%ymm15\n\t"
	                "\n\t"
	                "vperm2f128 $0x00, %%ymm2, %%ymm2, %%ymm8 \n\t"
	                "vperm2f128 $0x11, %%ymm2, %%ymm2, %%ymm9 \n\t"
	                "vshufpd    $0x00, %%ymm6, %%ymm6, %%ymm10\n\t"
	                "vshufpd    $0x0f, %%ymm6, %%ymm6, %%ymm11\n\t"
	                "vfmadd231pd %%ymm8 , %%ymm10, %%ymm12\n\t"
	                "vfmadd231pd %%ymm9 , %%ymm10, %%ymm13\n\t"
	                "vfmadd231pd %%ymm8 , %%ymm11, %%ymm14\n\t"
	                "vfmadd231pd %%ymm9 , %%ymm11, %%ymm15\n\t"
	                "\n\t"
	                "vperm2f128 $0x00, %%ymm3, %%ymm3, %%ymm8 \n\t"
	                "vperm2f128 $0x11, %%ymm3, %%ymm3, %%ymm9 \n\t"
	        ...
	        if( K >> 3 ){
	          ...
	          while( k8-- ){
	            ...
	            __asm__ __volatile__ (
	                ...
	                "vmovapd  12*8(%[b]), %%ymm7 \n\t"
	                "\n\t"
	                "vperm2f128 $0x00, %%ymm0, %%ymm0, %%ymm2 \n\t"
	                "vperm2f128 $0x11, %%ymm0, %%ymm0, %%ymm3 \n\t"
	                "vshufpd    $0x00, %%ymm4, %%ymm4, %%ymm10\n\t"
	                "vshufpd    $0x0f, %%ymm4, %%ymm4, %%ymm11\n\t"
	                "vshufpd    $0x00, %%ymm5, %%ymm5, %%ymm12\n\t"
	                "vshufpd    $0x0f, %%ymm5, %%ymm5, %%ymm13\n\t"
	                ...
	                "vshufpd    $0x00, %%ymm6, %%ymm6, %%ymm10\n\t"
	                "vshufpd    $0x0f, %%ymm6, %%ymm6, %%ymm11\n\t"
	                "vshufpd    $0x00, %%ymm7, %%ymm7, %%ymm12\n\t"
	                "vshufpd    $0x0f, %%ymm7, %%ymm7, %%ymm13\n\t"
	                "vfmadd231pd %%ymm8 , %%ymm10, %%ymm14\n\t"
	                "vfmadd231pd %%ymm8 , %%ymm11, %%ymm15\n\t"
	                "vfmadd231pd %%ymm9 , %%ymm12, %%ymm14\n\t"
