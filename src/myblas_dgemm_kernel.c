	    ...
	    if( m >> 2 ){
	      ...
	      while( m4-- ){
	        ...
	        if( k >> 2 ){
	          ...
	          while( k4-- ){
	            a00 = *(A2 + 0 + 0*K1 ); a10 = *(A2 + 1 + 0*K1 ); a20 = *(A2 + 2 + 0*K1 ); a30 = *(A2 + 3 + 0*K1 ); // ymm0
	            a01 = *(A2 + 0 + 1*K1 ); a11 = *(A2 + 1 + 1*K1 ); a21 = *(A2 + 2 + 1*K1 ); a31 = *(A2 + 3 + 1*K1 ); // ymm1
	            a02 = *(A2 + 0 + 2*K1 ); a12 = *(A2 + 1 + 2*K1 ); a22 = *(A2 + 2 + 2*K1 ); a32 = *(A2 + 3 + 2*K1 ); // ymm2
	            a03 = *(A2 + 0 + 3*K1 ); a13 = *(A2 + 1 + 3*K1 ); a23 = *(A2 + 2 + 3*K1 ); a33 = *(A2 + 3 + 3*K1 ); // ymm3
	            b00 = *(B2 + 0 + 0*K1 ); b10 = *(B2 + 1 + 0*K1 ); b20 = *(B2 + 2 + 0*K1 ); b30 = *(B2 + 3 + 0*K1 ); // ymm4
	            b01 = *(B2 + 0 + 1*K1 ); b11 = *(B2 + 1 + 1*K1 ); b21 = *(B2 + 2 + 1*K1 ); b31 = *(B2 + 3 + 1*K1 ); // ymm5
	            b02 = *(B2 + 0 + 2*K1 ); b12 = *(B2 + 1 + 2*K1 ); b22 = *(B2 + 2 + 2*K1 ); b32 = *(B2 + 3 + 2*K1 ); // ymm6
	            b03 = *(B2 + 0 + 3*K1 ); b13 = *(B2 + 1 + 3*K1 ); b23 = *(B2 + 2 + 3*K1 ); b33 = *(B2 + 3 + 3*K1 ); // ymm7
