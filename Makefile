...
MYBLAS_SCAL_OBJS=src/myblas_dgemm_scale2d.o src/myblas_dgemm_scale2d_detail.o src/myblas_global.o
MYBLAS_KRNL_OBJS=src/myblas_dgemm_kernel.o src/myblas_dgemm_kernel_detail.o src/myblas_global.o
...
src/myblas_global.o     : src/myblas_global.c src/myblas_internal.h
